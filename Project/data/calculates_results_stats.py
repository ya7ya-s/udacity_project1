...
def calculates_results_stats(results_dic):
    ...
    for pet in results_dic:
        if results_dic[pet][3] == 1:
                results_stats_dic['n_dogs_img'] += 1 
        elif results_dic[pet][3] == 0:
                results_stats_dic['n_notdogs_img']+=1
        if results_dic[pet][2] == 1:
                results_stats_dic['n_match'] += 1
        if results_dic[pet][3] == 1 and results_dic[pet][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1 
        if results_dic[pet][3] == 0 and results_dic[pet][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1 
        if results_dic[pet][3] == 1 and results_dic[pet][2] == 1:
